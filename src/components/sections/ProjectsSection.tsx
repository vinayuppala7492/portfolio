...
const projects = [
  {
    ...
    tech: ["Python"],
    icon: Gamepad2,
    demo: "https://github.com/vinayuppala7492/python-projects/blob/main/Hangman_game.py",
    code: "https://github.com/vinayuppala7492/python-projects/blob/main/Hangman_game.py",
  },
  {
    ...
    tech: ["Python"],
    icon: Gamepad2,
    demo: "https://github.com/vinayuppala7492/Python-Projects/blob/main/rock_paper_scissor_project.py",
    code: "https://github.com/vinayuppala7492/Python-Projects/blob/main/rock_paper_scissor_project.py",
  },
  {
    ...
    tech: ["Python", "JSON"],
    icon: HelpCircle,
    demo: "https://github.com/vinayuppala7492/Python-Projects/blob/main/quiz.py",
    code: "https://github.com/vinayuppala7492/Python-Projects/blob/main/quiz.py",
  },
  {
    title: "Caesar Cipher",
    ...
    tech: ["Python"],
    icon: Lock,
    demo: "https://github.com/vinayuppala7492/Python-Projects/blob/main/Caesar_Cipher.py",
    code: "https://github.com/vinayuppala7492/Python-Projects/blob/main/Caesar_Cipher.py",
  },
  {
    ...
    tech: ["JavaScript"],
    icon: Brain,
    demo: "https://github.com/vinayuppala7492/Python-Projects/blob/main/Guess_the_number.py",
    code: "https://github.com/vinayuppala7492/Python-Projects/blob/main/Guess_the_number.py",
  },
];
