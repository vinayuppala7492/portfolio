...
return ( <section id="about" className="py-32 section-glow" ref={ref}> <div className="container px-4">
<motion.div
...
About <span className="gradient-text">Me</span> </h2> <p className="text-muted-foreground text-lg max-w-md mx-auto">
The story behind the code </p>
</motion.div>
