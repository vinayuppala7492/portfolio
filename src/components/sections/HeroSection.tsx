...
const HeroSection = () => {
return ( <section className="relative min-h-screen flex items-center justify-center hero-gradient-bg overflow-hidden">
  ...
  <div className="container relative z-10 text-center px-4">
    ...
    >
      ...
      <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-bold mb-6 tracking-tight">
        Hi, I'm <span className="gradient-text">Vinay Uppala</span>
      </h1>
      ...
      <motion.p
        ...
        className="text-muted-foreground max-w-none mx-auto mb-12 text-lg"
      >
        Exploring technology, building projects, and sharing what I learn.
      </motion.p>
